...
( gameObject1, gameObject2 )), or feed it your own list of objects to check against 
...
solution. I and several people I knew were frustrated with this issue, so I decided to 
make something we could use. I'm a new programmer, so by making this public, I figure 
